...
public class TokenTest {
    ...
    public void value() throws Exception {
        String CodeExample = "{Code example}";
        Token t = Token.obtainToken(Type.Code, CodeExample, 0, 0);
    ...
    public void intValue() throws Exception {
        String CodeExample = "{Code example}";
        Token t = Token.obtainToken(Type.Code, 123, 0, 0);
        assertTrue(t.intValue() == 123);

        Token t2 = Token.obtainToken(Type.Code, CodeExample, 0, 0);
    ...
    public void doubleValue() throws Exception {
        String CodeExample = "{Code example}";
        Token t = Token.obtainToken(Type.Code, 123.3d, 0, 0);
    ...
    public void obtainToken() throws Exception {
        Token t = Token.obtainToken(Type.Code, 0, 0);
    ...
    public void obtainToken1() throws Exception {
        Token t = Token.obtainToken(Type.Code, "Lala", 0, 0);
    ...
    public void recycle() throws Exception {
        ...
        Token t1 = Token.obtainToken(Type.Code, "Lala", 0, 0);
        t1.recycle();

        Token t2 = Token.obtainToken(Type.Code, 123, 1, 2);
        assertTrue(t2 == t1);
    }
